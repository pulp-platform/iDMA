...
| `idma_sim_tb_idma_transpose_tiles` | `rw_axi`, `FullDuplex` 0 and 1 | Back-to-back single-tile transposes, copy and MX quant; fails unless full duplex overlaps the tiles |
