...
/// used protocol.
module idma_legalizer_r_init_rw_axi_rw_obi #(
            ...
            if (EnableCompute && req_i.opt.compute.enable) begin
                unique case (req_i.opt.compute.op)
                    idma_pkg::COMPUTE_MXQUANT:
                        w_tf_d.length =
                            (req_i.length / idma_pkg::compute_in_bytes(idma_pkg::COMPUTE_MXQUANT))
                            * idma_pkg::compute_out_bytes(idma_pkg::COMPUTE_MXQUANT);
                    idma_pkg::COMPUTE_MXQUANT_FP16:
                        w_tf_d.length =
                            (req_i.length / idma_pkg::compute_in_bytes(idma_pkg::COMPUTE_MXQUANT_FP16))
                            * idma_pkg::compute_out_bytes(idma_pkg::COMPUTE_MXQUANT_FP16);
                    idma_pkg::COMPUTE_MXDEQUANT:
                        w_tf_d.length =
                            (req_i.length / idma_pkg::compute_in_bytes(idma_pkg::COMPUTE_MXDEQUANT))
                            * idma_pkg::compute_out_bytes(idma_pkg::COMPUTE_MXDEQUANT);
                    idma_pkg::COMPUTE_MXDEQUANT_FP16:
                        w_tf_d.length =
                            (req_i.length / idma_pkg::compute_in_bytes(idma_pkg::COMPUTE_MXDEQUANT_FP16))
