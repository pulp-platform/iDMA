...
module idma_backend_rw_axi_rw_axis #(
    ...
    cc_fall_through_register #(
        .data_t     ( read_meta_channel_tagged_t )
    ) i_ar_fall_through_register (
        .clk_i      ( clk_i             ),
        .rst_ni     ( rst_ni            ),
        .clr_i      ( 1'b0              ),
    ...
    if (RAWCouplingAvail) begin : gen_r_aw_coupler
        ...
        cc_stream_fifo_optimal_wrap #(
            .Depth        ( 2                    ),
            .data_t       ( write_meta_channel_tagged_t ),
            .PrintInfo    ( PrintFifoInfo        )
        ) i_aw_fifo (
            .clk_i,
            .rst_ni,
