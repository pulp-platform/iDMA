...
localparam int unsigned Rs1OpcByteWidth   = OpcodeWidth;
localparam int unsigned Rs1TpModeLsb      = 32'd16;
localparam int unsigned Rs1TpModeWidth    = TpModeWidth;
localparam int unsigned Rs2TpTensorMLsb   = 32'd0;
localparam int unsigned Rs2TpTensorMWidth = idma_pkg::TransposeDimWidth;
localparam int unsigned Rs2TpTensorNLsb   = 32'd12;
localparam int unsigned Rs2TpTensorNWidth = idma_pkg::TransposeDimWidth;
