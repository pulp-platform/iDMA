...
// Tracer macro of the rw_axi_rw_axis iDMA backend
`ifndef IDMA_TRACER_RW_AXI_RW_AXIS_SVH_
`define IDMA_TRACER_RW_AXI_RW_AXIS_SVH_
        ...
        forever begin \
            ...
            if(__backend_inst``.rst_ni & (|__backend_inst``.busy_o | \
                ...
                bus = '{ \
                    ...
                    "axis_read_rsp_valid": __backend_inst``.axis_read_req_i.tvalid, \
                    "axis_read_rsp_ready": __backend_inst``.axis_read_rsp_o.tready, \
                    "axis_read_rsp_strobe": __backend_inst``.axis_read_req_i.t.strb, \
                    ...
                    "axis_write_req_valid": __backend_inst``.axis_write_req_o.tvalid, \
                    "axis_write_req_ready": __backend_inst``.axis_write_rsp_i.tready, \
                    "axis_write_req_strobe": __backend_inst``.axis_write_req_o.t.strb \
                }; \
                /* Assembly */ \
