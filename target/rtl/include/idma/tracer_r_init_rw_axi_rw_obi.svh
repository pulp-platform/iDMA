...
// Tracer macro of the r_init_rw_axi_rw_obi iDMA backend
`ifndef IDMA_TRACER_R_INIT_RW_AXI_RW_OBI_SVH_
`define IDMA_TRACER_R_INIT_RW_AXI_RW_OBI_SVH_

`include "idma/tracer.svh"

// The tracer for the r_init_rw_axi_rw_obi iDMA
`define IDMA_TRACER_R_INIT_RW_AXI_RW_OBI(__backend_inst, __out_f) \
`ifndef SYNTHESIS \
    initial begin : inital_tracer_r_init_rw_axi_rw_obi \
...
`endif \
        ...
        forever begin \
            ...
            if(__backend_inst``.rst_ni & (|__backend_inst``.busy_o | \
                ...
                cnst = '{ \
                    "inst"               : `"__backend_inst`", \
                    "identifier"         : "r_init_rw_axi_rw_obi", \
