...
module idma_transport_layer_rw_axi_rw_axis #(
    ...
    strb_t axis_buffer_out_consumed;
    ...
    logic axi_aw_ready;
    logic axis_w_chan_valid;
    logic axis_w_chan_ready;
    logic axis_w_chan_first;
    ...
    always_comb begin : gen_write_multiplexer
        ...
        idma_pkg::AXI_STREAM: begin
            ...
            buffer_out_consumed = axis_buffer_out_consumed;
        end
        default: begin
            w_dp_req_ready   = 1'b0;
            buffer_out_ready = '0;
    ...
    idma_axis_write #(
        ...
        .buffer_out_consumed_o ( axis_buffer_out_consumed )
    );
