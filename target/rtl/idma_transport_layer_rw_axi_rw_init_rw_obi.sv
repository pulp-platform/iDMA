...
module idma_transport_layer_rw_axi_rw_init_rw_obi #(
    ...
    strb_t axi_buffer_out_consumed;
    strb_t init_buffer_out_ready;
    strb_t init_buffer_out_consumed;
    strb_t obi_buffer_out_ready;
    strb_t obi_buffer_out_consumed;
    ...
    logic axi_w_chan_valid;
    logic axi_w_chan_ready;
    logic axi_w_chan_first;
    logic axi_w_dp_rsp_valid;
    logic axi_w_dp_rsp_ready;
    logic axi_w_dp_ready;
    w_dp_rsp_t axi_w_dp_rsp;
    logic axi_aw_ready;
    logic init_w_chan_valid;
    logic init_w_chan_ready;
    logic init_w_chan_first;
    logic init_w_dp_rsp_valid;
    logic init_w_dp_rsp_ready;
    logic init_w_dp_ready;
    w_dp_rsp_t init_w_dp_rsp;
    logic init_aw_ready;
    logic obi_w_chan_valid;
    logic obi_w_chan_ready;
    logic obi_w_chan_first;
    ...
    always_comb begin : gen_write_multiplexer
        ...
        idma_pkg::AXI: begin
            ...
            buffer_out_consumed = axi_buffer_out_consumed;
        end
        idma_pkg::INIT: begin
            ...
            buffer_out_consumed = init_buffer_out_consumed;
        end
        idma_pkg::OBI: begin
            ...
            buffer_out_consumed = obi_buffer_out_consumed;
        end
        default: begin
            w_dp_req_ready   = 1'b0;
            buffer_out_ready = '0;
    ...
    idma_axi_write #(
        ...
        .buffer_out_consumed_o ( axi_buffer_out_consumed ),
    ...
    idma_init_write #(
        ...
        .buffer_out_consumed_o ( init_buffer_out_consumed )
    );
    ...
    idma_obi_write #(
        ...
        .buffer_out_consumed_o ( obi_buffer_out_consumed )
    );
