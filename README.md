...
- [`Python3 >= 3.11`](https://www.python.org/downloads/) with the libraries listed in
  [`pyproject.toml`](pyproject.toml), installed via [`uv`](https://docs.astral.sh/uv/): `uv sync`
