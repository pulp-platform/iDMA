...
// Source Stride 1
#define IDMA_REG32_2D_FRONTEND_STRIDE_SRC1_REG_OFFSET 0x1c

// Destination Stride 1
#define IDMA_REG32_2D_FRONTEND_STRIDE_DST1_REG_OFFSET 0x20

// Number of 2D repetitions 1
#define IDMA_REG32_2D_FRONTEND_NUM_REPETITIONS1_REG_OFFSET 0x24

// DMA Status
#define IDMA_REG32_2D_FRONTEND_STATUS_REG_OFFSET 0x28
...
#define IDMA_REG32_2D_FRONTEND_NEXT_ID_REG_OFFSET 0x2c

// Get ID of finished transactions.
#define IDMA_REG32_2D_FRONTEND_DONE_REG_OFFSET 0x30
