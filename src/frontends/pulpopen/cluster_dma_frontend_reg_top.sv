...
module cluster_dma_frontend_reg_top #(
  ...
  // To HW
  output cluster_dma_frontend_reg_pkg::cluster_dma_frontend_reg2hw_t reg2hw, // Write
  input  cluster_dma_frontend_reg_pkg::cluster_dma_frontend_hw2reg_t hw2reg, // Read
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[0] = (reg_addr == CLUSTER_DMA_FRONTEND_SRC_ADDR_OFFSET);
    addr_hit[1] = (reg_addr == CLUSTER_DMA_FRONTEND_DST_ADDR_OFFSET);
    addr_hit[2] = (reg_addr == CLUSTER_DMA_FRONTEND_NUM_BYTES_OFFSET);
    addr_hit[3] = (reg_addr == CLUSTER_DMA_FRONTEND_CONF_OFFSET);
    addr_hit[4] = (reg_addr == CLUSTER_DMA_FRONTEND_STATUS_OFFSET);
    addr_hit[5] = (reg_addr == CLUSTER_DMA_FRONTEND_NEXT_ID_OFFSET);
    addr_hit[6] = (reg_addr == CLUSTER_DMA_FRONTEND_DONE_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[0] & (|(CLUSTER_DMA_FRONTEND_PERMIT[0] & ~reg_be))) |
               (addr_hit[1] & (|(CLUSTER_DMA_FRONTEND_PERMIT[1] & ~reg_be))) |
               (addr_hit[2] & (|(CLUSTER_DMA_FRONTEND_PERMIT[2] & ~reg_be))) |
               (addr_hit[3] & (|(CLUSTER_DMA_FRONTEND_PERMIT[3] & ~reg_be))) |
               (addr_hit[4] & (|(CLUSTER_DMA_FRONTEND_PERMIT[4] & ~reg_be))) |
               (addr_hit[5] & (|(CLUSTER_DMA_FRONTEND_PERMIT[5] & ~reg_be))) |
               (addr_hit[6] & (|(CLUSTER_DMA_FRONTEND_PERMIT[6] & ~reg_be)))));
  end
  ...
  assign conf_we = addr_hit[3] & reg_we & !reg_error;
