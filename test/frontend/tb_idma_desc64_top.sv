...
module tb_idma_desc64_top
    ...
    class stimulus_t;
        ...
        constraint unsupported_beo_zero { burst.opt.beo.decouple_aw == '0 && burst.opt.beo.src_max_llen == '0 && burst.opt.beo.dst_max_llen == '0 && burst.opt.last == '0 && burst.opt.beo.decouple_rw == '0; }
